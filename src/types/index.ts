export interface Booking { id:string; booking_number:string; status:string; customer_id:string; technician_id?:string; service_id:string; scheduled_date:string; scheduled_slot?:string; total_amount:number; priority:string; created_at:string; pre_reschedule_status?:string }
